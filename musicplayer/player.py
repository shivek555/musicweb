...
def AddMusic():
    path = "C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\static\\music"
    if path:
       os.chdir(path)
...
image_icon = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\logo.png")
root.iconphoto(False, image_icon)


frameCnt = 30
frames = [PhotoImage(file='C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\aa1.gif',format = 'gif -index %i' %(i)) for i in range(frameCnt)]
...
# Button
ButtonPlay = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\play1.png")
Button(root, image=ButtonPlay, bg="#FFFFFF", bd=0, height = 60, width =60,
       command=PlayMusic).place(x=215, y=487)

ButtonStop = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\stop1.png")
Button(root, image=ButtonStop, bg="#FFFFFF", bd=0, height = 60, width =60,
       command=mixer.music.stop).place(x=130, y=487)

Buttonvolume = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\volume.png")
Button(root, image=Buttonvolume, bg="#FFFFFF", bd=0, height = 60, width =60,
       command=mixer.music.unpause).place(x=20, y=487)

ButtonPause = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\pause1.png")
Button(root, image=ButtonPause, bg="#FFFFFF", bd=0, height = 60, width =60,
       command=mixer.music.pause).place(x=300, y=487)

# Label       
Menu = PhotoImage(file="C:\\Users\\Shivek S Mittal\\Desktop\\musicweb\\musicplayer\\menu.png")
